/*
1. W pliku Main12.java napisz program definiujący
   trzy liczby w zmiennych: a, b, c .
...
3. Tę figurę geometryczną można zbudować z trzech linii tylko wtedy,
   gdy suma długości dwóch z nich jest większa niż długość trzeciej linii, czyli:
